...
class Test(metaclass=synchronized_meta):
    __slots__ = "value", "_t1", "_t2", "_p1", "_p2", "hello"
...
if __name__ == "__main__":
    ...
    thread_1 = threading.Thread(target=test_increment1)
    thread_2 = threading.Thread(target=test_increment2)
    ...
    print(t.value, t._t1, t._t2, t._p1, t._p2)
