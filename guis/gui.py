...
class JinxGuiData(observable.Observable):
    ...
    __slots__ = ("__desired_view_state", "__view_states")
...
class ObserverWidget(QtWidgets.QWidget, observable.Observer):
    """A class defining an observer PyQt6 widget."""
...
class JinxGuiWindow(observable.Observer):
    ...
    def __init__(self, parent: QtWidgets.QWidget, data: JinxGuiData) -> None:
